...
export const EFFECT_TAGS: Record<EffectPrimitive["kind"], PlayEffectTag | null> = {
  ...
  coinFlipUnblockable: "stealth",
  unlockActorAtEndOfTurn: "unlock",
  removeTopOfTargetCrypt: "deny",
  burnActingSeatPool: "poolDrain",
  drawOnBleedSuccess: "board",
  unlockOnBleedSuccess: "unlock",
  actionUnlockMinion: "unlock",
  actionLockMinion: "deny",
  actionDamageMinion: "damage",
  actionDrawThenDiscard: "board",
  eachUnlockedVampireGainsBlood: "bloodGain",
  otherMinionPaysBlood: "stealth",
  blockCost: "stealth",
  ...
  bankBloodSweep: "bloodGain",
  bankBloodSplit: "bloodGain",
  ...
  strikeWeaponCost: "damage",
  cancelBlockCombat: "stealth",
  haymaker: "damage",
  strikePreventHandStrike: "prevent",
  strikeDamage: "damage",
  ...
  treatOpposingStrikeAsNormal: "prevent",
  strikeDestroyEquipment: "combat",
  opposingStrength: "combat",
  strikeWeaponDamage: "combat",
  strikesUndodgeableRound: "combat",
  swapStrikeOrder: "combat",
  handSizeOnNextRound: "combat",
  strikeStealEquipment: "combat",
  preventAllAggravated: "prevent",
  handStrikesAggravatedCombat: "combat",
  ...
  grantPress: "combat",
  takeEdge: "poolGain",
  burnEdgeForBleed: "bleed",
  preyMayTakeEdge: "poolGain",
  refGiveEdge: "poolGain",
  pressToStrikerIfDamaged: "combat",
  maneuver: "combat",
  setRangeLong: "combat",
  press: "combat",
  ...
  wake: "wake",
  noLockForBlocking: "wake",
  bloodForVotes: "votes",
  taxVotesAgainst: "votes",
  wakeOther: "wake",
